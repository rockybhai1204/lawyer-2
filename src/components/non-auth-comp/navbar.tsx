                  ...
                  <div className="flex items-center justify-between w-[70%] px-8 xl:px-12 2xl:px-16">
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <Link
                          href="/services"
                          className="cursor-pointer text-gray-800 group-hover:text-cyan-500 transition-all duration-300 font-bold font-['Lora'] whitespace-nowrap flex items-center space-x-1"
