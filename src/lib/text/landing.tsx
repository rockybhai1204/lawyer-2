export const landing = {
  ...
  third: {
    ...
    packages: {
      rent: [
        {
          title: "Plain Draft",
          desc: "Get a professional draft you can use immediately",
        },
        {
          title: "Notarized",
          desc: "Includes notarization for legal validity",
        },
        {
          title: "Registered",
          desc: "End-to-end drafting+registration support",
        },
      ],
      other: [
        {
          title: "Plain Draft",
          desc: "Get a standard draft by our expert lawyer",
        },
        {
  ...
  sixth: {
    team: {
      ...
      progress: {
        communication: "Client's Communication",
    ...
    steps: [
      {
        ...
        desc: "Property, rent, family, or business-related.",
      },
      {
        title: "Book Online Consultation",
        desc: "Instantly connect with one of our expert lawyers.",
      },
      {
        title: "Discuss Your Needs",
        desc: "10-minute pre-consultation included.",
      },
      {
        title: "Get Drafted / Reviewed",
        desc: "Receive professional documents or reports.",
      },
      {
        title: "Delivery & Support",
        desc: "Plain draft, notarized, registered, or eSigned.",
      },
    ],
  },
  ninth: {
    ...
    buttons: {
      register: "Register Lawyer",
      bookLine1: "Book Your Online",
      bookLine2: "Consultation Now",
    },
  },
  tenth: {
    companyName: "Vakilfy",
